...
def _write_note(root, area, entries):
    ...
    lines = [f"# {area} 归档说明", "",
             ...
             f"> 由 `$AIDP_HOME/scripts/archive_old_artifacts.py` 维护，最后更新 {mf['updated_at']}。",
             f"> 还原：`python3 $AIDP_HOME/scripts/archive_old_artifacts.py restore --area {area} --version <V> --apply`", "",
