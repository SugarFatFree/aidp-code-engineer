...
## 用法
    ...
    python3 .aidp/scripts/baseline_archive.py                 # 执行归档
    python3 .aidp/scripts/baseline_archive.py --dry-run       # 只报不写
    python3 .aidp/scripts/baseline_archive.py --json          # 机读
    python3 .aidp/scripts/baseline_archive.py --keep 3        # 多留一版
