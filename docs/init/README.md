...
`docs/` 下 14 个子目录的**隔离级别、职责与写入者速查** 见 [`../README.md`](../README.md)（`docs/` 目录说明）——含"项目级 / 版本级 / 版本+用户级"三层划分、各子目录写入者、文件命名规范，以及 `deployment/tools/`（**非版本隔离**特例）等易放错的路径。路径的**权威定义**仍以本目录 [`06_版本与用户目录约定.md`](06_版本与用户目录约定.md) 为准。
